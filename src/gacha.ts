...
export const CHARACTER_POOL: Character[] = [
    ...
    {id: 18, name: "Soldier 0 Anby", rarity: "S", baseClick: 7, baseCps: 2.8},
    ...
    {id: 34, name: "Soldier 11", rarity: "S", baseClick: 11, baseCps: 0.5},
    {id: 35, name: "Nekomata", rarity: "S", baseClick: 5, baseCps: 3},
    {id: 36, name: "Lycaon", rarity: "S", baseClick: 6, baseCps: 4},
    {id: 37, name: "Koleda", rarity: "S", baseClick: 2, baseCps: 7},
